...
LDLIBSOPTIONS=-L../UTILS/dist/Release_Cygwin/Cygwin_4.x-Windows -lUTILS -L../MATH/dist/Release_Cygwin/Cygwin_4.x-Windows -lMATH -L../NISTThermo/NISTThermo/dist/Release_Cygwin/Cygwin_4.x-Windows -lNISTThermo -L../EOS/dist/Release_Cygwin/Cygwin_4.x-Windows -lEOS

# Build Targets
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/mpflow3d.exe

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/mpflow3d.exe: ../UTILS/dist/Release_Cygwin/Cygwin_4.x-Windows/libUTILS.dll

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/mpflow3d.exe: ../MATH/dist/Release_Cygwin/Cygwin_4.x-Windows/libMATH.dll

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/mpflow3d.exe: ../NISTThermo/NISTThermo/dist/Release_Cygwin/Cygwin_4.x-Windows/libNISTThermo.dll

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/mpflow3d.exe: ../EOS/dist/Release_Cygwin/Cygwin_4.x-Windows/libEOS.dll
...
${OBJECTDIR}/src/BC.o: src/BC.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.cc) -O2 -Wall -I.. -I../UTILS/include -I../MATH/include -I../EOS/include -Iinclude -march=native -Wno-write-strings -fno-math-errno -fno-trapping-math -ffinite-math-only -fno-signaling-nans -fstrict-aliasing -fomit-frame-pointer -fpermissive -fexpensive-optimizations -funroll-all-loops -ffast-math -finline-limit=150000 -mfpmath=sse -msse2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/BC.o src/BC.cpp
...
${OBJECTDIR}/src/Test.o: src/Test.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.cc) -O2 -Wall -I.. -I../UTILS/include -I../MATH/include -I../EOS/include -Iinclude -march=native -Wno-write-strings -fno-math-errno -fno-trapping-math -ffinite-math-only -fno-signaling-nans -fstrict-aliasing -fomit-frame-pointer -fpermissive -fexpensive-optimizations -funroll-all-loops -ffast-math -finline-limit=150000 -mfpmath=sse -msse2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/Test.o src/Test.cpp
...
.build-subprojects:
	...
	cd ../NISTThermo/NISTThermo && ${MAKE}  -f Makefile CONF=Release_Cygwin
	cd ../EOS && ${MAKE}  -f Makefile CONF=Release_Cygwin
...
.clean-subprojects:
	...
	cd ../NISTThermo/NISTThermo && ${MAKE}  -f Makefile CONF=Release_Cygwin clean
	cd ../EOS && ${MAKE}  -f Makefile CONF=Release_Cygwin clean
