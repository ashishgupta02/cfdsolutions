...
void RMS_Writer_Init(void) {
    ...
    if (VariableType == VARIABLE_CON) {
        ...
        if (PrecondMethod == PRECOND_METHOD_NONE) {
            fprintf(RMS_FP, "=============================================================================================================================================================================\n");
            fprintf(RMS_FP, "-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------\n");
            fprintf(RMS_FP, " Iter     RMS_RHO       RMS_U       RMS_V       RMS_W       RMS_T     RMS_RES    MIN_TIME    MAX_TIME  MIN_LAMDA1  MAX_LAMDA1  MIN_LAMDA4  MAX_LAMDA4  MIN_LAMDA5  MAX_LAMDA5\n");
            fprintf(RMS_FP, "-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------\n");
        } else {
            fprintf(RMS_FP, "=====================================================================================================================================================================================================\n");
            fprintf(RMS_FP, "-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------\n");
            fprintf(RMS_FP, " Iter     RMS_RHO       RMS_U       RMS_V       RMS_W       RMS_T     RMS_RES    MIN_TIME    MAX_TIME  MIN_LAMDA1  MAX_LAMDA1  MIN_LAMDA4  MAX_LAMDA4  MIN_LAMDA5  MAX_LAMDA5   MIN_SIGMA   MAX_SIGMA\n");
            fprintf(RMS_FP, "-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------\n");
        }
    }
    fflush(RMS_FP);
