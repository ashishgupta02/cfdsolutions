...
LDLIBSOPTIONS=-L../UTILS/dist/Release_Cygwin/Cygwin_4.x-Windows -lUTILS

# Build Targets
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/libMATH.dll

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/libMATH.dll: ../UTILS/dist/Release_Cygwin/Cygwin_4.x-Windows/libUTILS.dll
