...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-Debug_SS.mk dist/Debug_SS/OracleSolarisStudio-Linux-x86/euler3d

dist/Debug_SS/OracleSolarisStudio-Linux-x86/euler3d: ${OBJECTFILES}
	${MKDIR} -p dist/Debug_SS/OracleSolarisStudio-Linux-x86
...
${OBJECTDIR}/src/MC_Iterative_Jacobi.o: nbproject/Makefile-${CND_CONF}.mk src/MC_Iterative_Jacobi.c 
	${MKDIR} -p ${OBJECTDIR}/src
	$(COMPILE.c) -g +w -Iinclude -o ${OBJECTDIR}/src/MC_Iterative_Jacobi.o src/MC_Iterative_Jacobi.c

${OBJECTDIR}/src/Vector3D.o: nbproject/Makefile-${CND_CONF}.mk src/Vector3D.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	$(COMPILE.cc) -g +w -Iinclude -o ${OBJECTDIR}/src/Vector3D.o src/Vector3D.cpp

${OBJECTDIR}/src/BC.o: nbproject/Makefile-${CND_CONF}.mk src/BC.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	$(COMPILE.cc) -g +w -Iinclude -o ${OBJECTDIR}/src/BC.o src/BC.cpp
...
${OBJECTDIR}/_ext/979082451/Roe_EntropyFix.o: nbproject/Makefile-${CND_CONF}.mk /home/agupta/NetBeansProjects/CFDSolutions/Trunk/Euler3D/src/Roe_EntropyFix.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/979082451
	$(COMPILE.cc) -g +w -Iinclude -o ${OBJECTDIR}/_ext/979082451/Roe_EntropyFix.o /home/agupta/NetBeansProjects/CFDSolutions/Trunk/Euler3D/src/Roe_EntropyFix.cpp

${OBJECTDIR}/src/Time_Step.o: nbproject/Makefile-${CND_CONF}.mk src/Time_Step.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	$(COMPILE.cc) -g +w -Iinclude -o ${OBJECTDIR}/src/Time_Step.o src/Time_Step.cpp

${OBJECTDIR}/src/LMRoe_Fluxes.o: nbproject/Makefile-${CND_CONF}.mk src/LMRoe_Fluxes.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	$(COMPILE.cc) -g +w -Iinclude -o ${OBJECTDIR}/src/LMRoe_Fluxes.o src/LMRoe_Fluxes.cpp

${OBJECTDIR}/src/Gradient.o: nbproject/Makefile-${CND_CONF}.mk src/Gradient.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	$(COMPILE.cc) -g +w -Iinclude -o ${OBJECTDIR}/src/Gradient.o src/Gradient.cpp

${OBJECTDIR}/src/Trim_Utils.o: nbproject/Makefile-${CND_CONF}.mk src/Trim_Utils.c 
	${MKDIR} -p ${OBJECTDIR}/src
	$(COMPILE.c) -g +w -Iinclude -o ${OBJECTDIR}/src/Trim_Utils.o src/Trim_Utils.c

${OBJECTDIR}/src/Area_Volume.o: nbproject/Makefile-${CND_CONF}.mk src/Area_Volume.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	$(COMPILE.cc) -g +w -Iinclude -o ${OBJECTDIR}/src/Area_Volume.o src/Area_Volume.cpp

${OBJECTDIR}/src/List.o: nbproject/Makefile-${CND_CONF}.mk src/List.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	$(COMPILE.cc) -g +w -Iinclude -o ${OBJECTDIR}/src/List.o src/List.cpp
...
${OBJECTDIR}/_ext/979082451/CompressibleUtils.o: nbproject/Makefile-${CND_CONF}.mk /home/agupta/NetBeansProjects/CFDSolutions/Trunk/Euler3D/src/CompressibleUtils.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/979082451
	$(COMPILE.cc) -g +w -Iinclude -o ${OBJECTDIR}/_ext/979082451/CompressibleUtils.o /home/agupta/NetBeansProjects/CFDSolutions/Trunk/Euler3D/src/CompressibleUtils.cpp

${OBJECTDIR}/src/MeshIO.o: nbproject/Makefile-${CND_CONF}.mk src/MeshIO.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	$(COMPILE.cc) -g +w -Iinclude -o ${OBJECTDIR}/src/MeshIO.o src/MeshIO.cpp
...
${OBJECTDIR}/src/Solver.o: nbproject/Makefile-${CND_CONF}.mk src/Solver.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	$(COMPILE.cc) -g +w -Iinclude -o ${OBJECTDIR}/src/Solver.o src/Solver.cpp

${OBJECTDIR}/src/Connectivity_Maps.o: nbproject/Makefile-${CND_CONF}.mk src/Connectivity_Maps.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	$(COMPILE.cc) -g +w -Iinclude -o ${OBJECTDIR}/src/Connectivity_Maps.o src/Connectivity_Maps.cpp

${OBJECTDIR}/src/DebugSolver.o: nbproject/Makefile-${CND_CONF}.mk src/DebugSolver.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	$(COMPILE.cc) -g +w -Iinclude -o ${OBJECTDIR}/src/DebugSolver.o src/DebugSolver.cpp
...
.clean-conf: ${CLEAN_SUBPROJECTS}
	${RM} -r build/Debug_SS
	${RM} dist/Debug_SS/OracleSolarisStudio-Linux-x86/euler3d
	${CCADMIN} -clean
