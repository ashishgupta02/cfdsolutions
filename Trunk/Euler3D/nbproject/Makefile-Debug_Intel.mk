...
${OBJECTDIR}/src/FluxTest.o: src/FluxTest.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.cc) -g -Wall -DHAVE_MPI -I.. -I../UTILS/include -I../MATH/include -Iinclude -I/home/agupta/00-Applications/Lakesite/HPC_LIBS/include -axSSE4.2 -Wno-write-strings -fno-math-errno -fstrict-aliasing -fomit-frame-pointer -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/FluxTest.o src/FluxTest.cpp
