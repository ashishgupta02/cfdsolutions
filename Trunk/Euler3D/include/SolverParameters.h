...
enum PRECOND_METHOD {
    ...
    PRECOND_METHOD_ROE_WS = 1, /*!< \brief Solver Preconditioning Roe Weiss-Smith with Marco Fix. */
    PRECOND_METHOD_ROE_WS_ORIGINAL = 2, /*!< \brief Solver Preconditioning Roe Weiss-Smith. */
    PRECOND_METHOD_ROE_CV = 3, /*!< \brief Solver Preconditioning Roe Cecile-Voizat with Marco Fix. */
    PRECOND_METHOD_ROE_CV_ORIGINAL = 4, /*!< \brief Solver Preconditioning Roe Ceclie-Voizat. */
    PRECOND_METHOD_ROE_BTW = 5, /*!< \brief Solver Preconditioning Roe Briley Taylor Whitfield with Marco Fix. */
    PRECOND_METHOD_ROE_BTW_ORIGINAL = 6, /*!< \brief Solver Preconditioning Roe Briley Taylor Whitfield. */
    PRECOND_METHOD_ROE_ERIKSSON = 7, /*!< \brief Solver Preconditioning Roe Eriksson with Marco Fix. */
    PRECOND_METHOD_ROE_ERIKSSON_ORIGINAL = 8, /*!< \brief Solver Preconditioning Roe Eriksson. */
    PRECOND_METHOD_ROE_MERKEL = 9, /*!< \brief Solver Preconditioning Roe Merkel with Marco Fix. */
    PRECOND_METHOD_ROE_MERKEL_ORIGINAL = 10, /*!< \brief Solver Preconditioning Roe Merkel. */
    PRECOND_METHOD_ROE_TURKEL = 11, /*!< \brief Solver Preconditioning Roe Turkel with Marco Fix. */
    PRECOND_METHOD_ROE_TURKEL_ORIGINAL = 12, /*!< \brief Solver Preconditioning Roe Turkel. */
    PRECOND_METHOD_HLLC_LMFIX = 13 /*!< \brief Solver Preconditioning HLLC LMFix. */ 
};
...
("PRECOND_METHOD_ROE_WS_ORIGINAL", PRECOND_METHOD_ROE_WS_ORIGINAL)
("PRECOND_METHOD_ROE_CV", PRECOND_METHOD_ROE_CV)
("PRECOND_METHOD_ROE_CV_ORIGINAL", PRECOND_METHOD_ROE_CV_ORIGINAL)
("PRECOND_METHOD_ROE_BTW", PRECOND_METHOD_ROE_BTW)
("PRECOND_METHOD_ROE_BTW_ORIGINAL", PRECOND_METHOD_ROE_BTW_ORIGINAL)
("PRECOND_METHOD_ROE_ERIKSSON", PRECOND_METHOD_ROE_ERIKSSON)
("PRECOND_METHOD_ROE_ERIKSSON_ORIGINAL", PRECOND_METHOD_ROE_ERIKSSON_ORIGINAL)
("PRECOND_METHOD_ROE_MERKEL", PRECOND_METHOD_ROE_MERKEL)
("PRECOND_METHOD_ROE_MERKEL_ORIGINAL", PRECOND_METHOD_ROE_MERKEL_ORIGINAL)
("PRECOND_METHOD_ROE_TURKEL", PRECOND_METHOD_ROE_TURKEL)
("PRECOND_METHOD_ROE_TURKEL_ORIGINAL", PRECOND_METHOD_ROE_TURKEL_ORIGINAL)
