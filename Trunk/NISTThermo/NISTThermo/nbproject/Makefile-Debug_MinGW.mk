...
${OBJECTDIR}/src/cmns.o: src/cmns.f 
	...
	$(COMPILE.f) -g -Wall  -o ${OBJECTDIR}/src/cmns.o src/cmns.f

${OBJECTDIR}/src/core_anc.o: src/core_anc.f 
	${MKDIR} -p ${OBJECTDIR}/src
	$(COMPILE.f) -g -Wall  -o ${OBJECTDIR}/src/core_anc.o src/core_anc.f

${OBJECTDIR}/src/core_bwr.o: src/core_bwr.f 
	${MKDIR} -p ${OBJECTDIR}/src
	$(COMPILE.f) -g -Wall  -o ${OBJECTDIR}/src/core_bwr.o src/core_bwr.f

${OBJECTDIR}/src/core_cpp.o: src/core_cpp.f 
	${MKDIR} -p ${OBJECTDIR}/src
	$(COMPILE.f) -g -Wall  -o ${OBJECTDIR}/src/core_cpp.o src/core_cpp.f

${OBJECTDIR}/src/core_de.o: src/core_de.f 
	${MKDIR} -p ${OBJECTDIR}/src
	$(COMPILE.f) -g -Wall  -o ${OBJECTDIR}/src/core_de.o src/core_de.f

${OBJECTDIR}/src/core_ecs.o: src/core_ecs.f 
	${MKDIR} -p ${OBJECTDIR}/src
	$(COMPILE.f) -g -Wall  -o ${OBJECTDIR}/src/core_ecs.o src/core_ecs.f

${OBJECTDIR}/src/core_feq.o: src/core_feq.f 
	${MKDIR} -p ${OBJECTDIR}/src
	$(COMPILE.f) -g -Wall  -o ${OBJECTDIR}/src/core_feq.o src/core_feq.f

${OBJECTDIR}/src/core_mlt.o: src/core_mlt.f 
	${MKDIR} -p ${OBJECTDIR}/src
	$(COMPILE.f) -g -Wall  -o ${OBJECTDIR}/src/core_mlt.o src/core_mlt.f

${OBJECTDIR}/src/core_ph0.o: src/core_ph0.f 
	${MKDIR} -p ${OBJECTDIR}/src
	$(COMPILE.f) -g -Wall  -o ${OBJECTDIR}/src/core_ph0.o src/core_ph0.f

${OBJECTDIR}/src/core_pr.o: src/core_pr.f 
	${MKDIR} -p ${OBJECTDIR}/src
	$(COMPILE.f) -g -Wall  -o ${OBJECTDIR}/src/core_pr.o src/core_pr.f

${OBJECTDIR}/src/core_qui.o: src/core_qui.f 
	${MKDIR} -p ${OBJECTDIR}/src
	$(COMPILE.f) -g -Wall  -o ${OBJECTDIR}/src/core_qui.o src/core_qui.f

${OBJECTDIR}/src/core_stn.o: src/core_stn.f 
	${MKDIR} -p ${OBJECTDIR}/src
	$(COMPILE.f) -g -Wall  -o ${OBJECTDIR}/src/core_stn.o src/core_stn.f

${OBJECTDIR}/src/flash2.o: src/flash2.f 
	${MKDIR} -p ${OBJECTDIR}/src
	$(COMPILE.f) -g -Wall  -o ${OBJECTDIR}/src/flash2.o src/flash2.f

${OBJECTDIR}/src/flsh_sub.o: src/flsh_sub.f 
	${MKDIR} -p ${OBJECTDIR}/src
	$(COMPILE.f) -g -Wall  -o ${OBJECTDIR}/src/flsh_sub.o src/flsh_sub.f

${OBJECTDIR}/src/idealgas.o: src/idealgas.f 
	${MKDIR} -p ${OBJECTDIR}/src
	$(COMPILE.f) -g -Wall  -o ${OBJECTDIR}/src/idealgas.o src/idealgas.f

${OBJECTDIR}/src/mix_aga8.o: src/mix_aga8.f 
	${MKDIR} -p ${OBJECTDIR}/src
	$(COMPILE.f) -g -Wall  -o ${OBJECTDIR}/src/mix_aga8.o src/mix_aga8.f

${OBJECTDIR}/src/mix_hmx.o: src/mix_hmx.f 
	${MKDIR} -p ${OBJECTDIR}/src
	$(COMPILE.f) -g -Wall  -o ${OBJECTDIR}/src/mix_hmx.o src/mix_hmx.f

${OBJECTDIR}/src/nist_extension_mp_pd.o: src/nist_extension_mp_pd.f 
	${MKDIR} -p ${OBJECTDIR}/src
	$(COMPILE.f) -g -Wall  -o ${OBJECTDIR}/src/nist_extension_mp_pd.o src/nist_extension_mp_pd.f

${OBJECTDIR}/src/nist_extension_mp_td.o: src/nist_extension_mp_td.f 
	${MKDIR} -p ${OBJECTDIR}/src
	$(COMPILE.f) -g -Wall  -o ${OBJECTDIR}/src/nist_extension_mp_td.o src/nist_extension_mp_td.f

${OBJECTDIR}/src/nist_extension_pd.o: src/nist_extension_pd.f 
	${MKDIR} -p ${OBJECTDIR}/src
	$(COMPILE.f) -g -Wall  -o ${OBJECTDIR}/src/nist_extension_pd.o src/nist_extension_pd.f

${OBJECTDIR}/src/nist_extension_td.o: src/nist_extension_td.f 
	${MKDIR} -p ${OBJECTDIR}/src
	$(COMPILE.f) -g -Wall  -o ${OBJECTDIR}/src/nist_extension_td.o src/nist_extension_td.f

${OBJECTDIR}/src/prop_sub.o: src/prop_sub.f 
	${MKDIR} -p ${OBJECTDIR}/src
	$(COMPILE.f) -g -Wall  -o ${OBJECTDIR}/src/prop_sub.o src/prop_sub.f

${OBJECTDIR}/src/realgas.o: src/realgas.f 
	${MKDIR} -p ${OBJECTDIR}/src
	$(COMPILE.f) -g -Wall  -o ${OBJECTDIR}/src/realgas.o src/realgas.f

${OBJECTDIR}/src/sat_sub.o: src/sat_sub.f 
	${MKDIR} -p ${OBJECTDIR}/src
	$(COMPILE.f) -g -Wall  -o ${OBJECTDIR}/src/sat_sub.o src/sat_sub.f

${OBJECTDIR}/src/setup.o: src/setup.f 
	${MKDIR} -p ${OBJECTDIR}/src
	$(COMPILE.f) -g -Wall  -o ${OBJECTDIR}/src/setup.o src/setup.f

${OBJECTDIR}/src/setup2.o: src/setup2.f 
	${MKDIR} -p ${OBJECTDIR}/src
	$(COMPILE.f) -g -Wall  -o ${OBJECTDIR}/src/setup2.o src/setup2.f

${OBJECTDIR}/src/trns_ecs.o: src/trns_ecs.f 
	${MKDIR} -p ${OBJECTDIR}/src
	$(COMPILE.f) -g -Wall  -o ${OBJECTDIR}/src/trns_ecs.o src/trns_ecs.f

${OBJECTDIR}/src/trns_tcx.o: src/trns_tcx.f 
	${MKDIR} -p ${OBJECTDIR}/src
	$(COMPILE.f) -g -Wall  -o ${OBJECTDIR}/src/trns_tcx.o src/trns_tcx.f

${OBJECTDIR}/src/trns_vis.o: src/trns_vis.f 
	${MKDIR} -p ${OBJECTDIR}/src
	$(COMPILE.f) -g -Wall  -o ${OBJECTDIR}/src/trns_vis.o src/trns_vis.f

${OBJECTDIR}/src/trnsp.o: src/trnsp.f 
	${MKDIR} -p ${OBJECTDIR}/src
	$(COMPILE.f) -g -Wall  -o ${OBJECTDIR}/src/trnsp.o src/trnsp.f

${OBJECTDIR}/src/utility.o: src/utility.f 
	${MKDIR} -p ${OBJECTDIR}/src
	$(COMPILE.f) -g -Wall  -o ${OBJECTDIR}/src/utility.o src/utility.f
